...
namespace BattleShipApi.Managers
{
    public class BoardManager : IBoardManager
    {
        ...
        public ResultDTO<BoardState> PlaceBattleShip(string boardID, BattleShipDTO battleShipDTO)
        {
            ...
            if (!CellValid)
            {
                return PlaceBattleShipResult.FromError("Invalid Starting Cell. RowID and Column ID should be greater than 0 and should not exceed maximum number of rows in board");
            }
